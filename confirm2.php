...
if(isset($_POST['confirm'])){
 ...
 $result2= mysqli_query($conn, $sql2) or die("query unsuccessful2");
 $row2=mysqli_fetch_assoc($result2);

 $sql5="SELECT * FROM `t_fair1` WHERE id=1";  
 $result5= mysqli_query($conn, $sql5) or die("query unsuccessful3");
...
" at 7.30 AM."  ?><br>In the situation of Covid crysis, We are requesting you to follow the Covid guidelines according to Indian government.<a href="https://covid19.india.gov.in/document/guidelines-for-domestic-travel-air-train-inter-state-bus-travel/"> See the details here</a></p>
