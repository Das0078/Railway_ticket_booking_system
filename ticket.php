...
<form action="index.php" method="post">
       ...
       <div class="head1"><h5><b><u>Nested train's e-Ticketing Services </u></b></h3></div>
        <div class="head2"><h5><b><u>Electronic Reservation Slip (Personal User) </u></b></h3></div>
            ...
            <table border="1px" class="tab-1">
                <tr>
                    <td><b>PNR No:</b><p><?php echo $pnr=4568395834757 ?></p></td>
                    <td><b>Train No. & Name: </b><p><?php echo $tname="18099/NETAJI EXP"?></p></td>
                    <td><b>Quota: </b><p><?php echo $ocp= $row3['occup']; ?></p></td>
                </tr>
                <tr>
                    <td><b>Transaction ID:</b><p><?php echo $tid=10003757497540500 ?></p></td>
                    <td><b>Date & Time of Booking: </b><p><?php echo $dt= date("d-m-Y")." ". date("h.i A")?></p></td>
                    <td><b>Class: </b><p><?php echo $cl=$row3['class']; ?></p></td>
                </tr>
                <tr>
                    <td><b>From:</b><p><?php echo $frm= $row3['board']; ?></p></td>
                    <td><b>To: </b><p><?php echo $to= $row3['destination']; ?></p></td>
                    <td><b>Date & Time of train: </b><p><?php echo $dt2= $row3['calen']." 2.30 AM"; ?></p></td>
                </tr>
         ...
         <a href="index.php"> <button type="submit" class="btn btn-primary" name="search">Save & Exit</button></a>
     </div>
</form>
    <?php
    include "config.php";
    ...
    $sql7="UPDATE `history` SET `id`='1',`pnr`='$pnr',`train`='$tname',`quote`='$ocp',`trans`='$tid',`booking`='$dt',`class`='$cl',`start`='$frm',`finish`='$to',`train_dtls`='$dt2' WHERE 1";
