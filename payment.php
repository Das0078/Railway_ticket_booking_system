...
<body>
   ...
   $result5= mysqli_query($conn, $sql5) or die("query unsuccessful1");
   ...
   $resultt= mysqli_query($conn, $sqll) or die("query unsuccessful2");

   }elseif(isset($_POST['search2'])){
      $a2=$row5['sb'];
      $sqll="UPDATE `t_fair1` SET `id`='1',`price`='$a2'";
      $resultt= mysqli_query($conn, $sqll) or die("query unsuccessful3");
   }else{
      $a3=$row5['sc'];
      $sqll="UPDATE `t_fair1` SET `id`='1',`price`='$a3'";
      $resultt= mysqli_query($conn, $sqll) or die("query unsuccessful4");
   }
   ...
   ?>
     ...
     <form action="confirm.php" method="post">
        <h3>Payment Info</h3>
               ...
               <button type="submit" class="btn btn-primary" name="confirm">Confirm & Process</button>
